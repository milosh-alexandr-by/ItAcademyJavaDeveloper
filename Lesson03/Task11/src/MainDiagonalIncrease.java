	...
	public static void main(String[] args) {
		...
		for (int w=0; w<n; w++) {
			...
			for (int z=n-1; z>=w; z--) {
				if (ar[z]<= min) {
					min = ar[z];
					f = z;                                // f - это позици€ минимального элемента
				}
			}
			int k = f;
			for (int m=k; m>=w+1; m--){
		...
		System.out.print("Ќовый массив M[] дл€ удобства: ");
		for (int i=0; i<n; i++) {
			if (i==n-1) {
...
//		int n=10;
		...
		// помен€ть два первых значени€ массива
//		int a = ar[1];
//		ar[1] = ar[0];
//		ar[0] = a;
...
//		System.out.println("число: " + min + ", номер символа: " + f);
		...
		// упор€дочить элементы по возрастанию
...
//			}
//		}
//		System.out.println(" оличество нулей: " + sum);
		
//		int nov[] = new int[10];
//		System.out.print("Nov ћассив: ");
//		
//		int num = 0;
//		int k = 0;
//		for (int i=0; i<10; i++) {
