...
public class MainDiagonalIncrease {
	...
	public static void main(String[] args) {
		...
		// я сначала определял элементы главной матрицы
		// потом упорядочивал их по возрастанию
		// а потом к каждому элементу я распологал соответсвующий столбец и делал новую матрицу
		
		// ошибка в том, что когда в нулевом столбце дигональный элемент столит на позиции [0]
		// то переставив столбец на другое место
		// диагональный элемент будет соответсовать уже другой позиции, например [2]
		
		// SEE: Lesson03\Task11_01
...
//		int n=10;
		...
		// !!!!!!
		// алгоритм, который ставит в соответствие матрицу и элементы упорядоченной дигонали
