...
//		n = 8;
		...
		System.out.print("Ёлементы главной диагонали: ");
		for (int r=0; r<n; r++) {
			if (r==(n-1)) {
		...
		// теперь перебираем все варианты, как могут сто€ть столбцы: 12345; 12354; 12435...
		// видно, что это напоминает числа
		// сопоставим каждому числу расположение столбцов в матрице
		// прогоним все числа n - значные 
		// но наложим два услови€: чтобы все цифры были разные
		...
		for (int i=minCharacter; i<(maxCharacter-1); i++) {
			...
			// провер€ем состоит ли массив из разных цифр
			// берЄм каждую цифру и перебором проходим и сравниваем с другими
			...
			if (sum==0) {
				...
				// провер€ем каждую цифру, чтобы она была между 1 и n включительно
				int prov = 0;
				...
				// создадим новую матрицу согласно числу
					...
					for (int ds=0; ds<=(n-1); ds++) {
						...
						// проверим, идут ли элементы массива, то есть главной диагонали по возрастанию
						int sok = 0;
